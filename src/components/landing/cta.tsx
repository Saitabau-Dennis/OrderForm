      ...
      <div className="max-w-7xl mx-auto px-6">
        <ScrollAnimation variant="fade-up">
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#04281e]">
            ...
            <div className="relative z-10 flex flex-col items-center text-center px-6 py-14 md:px-10 md:py-20">
              <h2 className="text-3xl font-heading font-normal tracking-tight text-white md:text-5xl">
                The fastest way to turn DMs into real orders
              </h2>
              <p className="mt-4 max-w-2xl text-base text-white/85 md:text-2xl">
              ...
              <LandingButton
                ...
                tone="outline"
                size="lg"
                className="mt-8 border-white/80 bg-transparent text-white hover:bg-white hover:text-[#04281e] focus-visible:ring-white focus-visible:ring-offset-[#04281e]"
              >
