             ...
             <div className="aspect-square w-full max-w-[500px] relative flex items-center justify-center">
                ...
                <div className="relative z-10 flex flex-col items-center gap-3">
                    <div className="relative group">
                        <div className="relative w-16 h-16 md:w-24 md:h-24 bg-primary rounded-none shadow-2xl border-4 border-white/20 flex items-center justify-center ring-1 ring-primary/20 group-hover:scale-105 transition-transform duration-500">
                             <MessageCircle className="w-6 h-6 md:w-10 md:h-10 text-white fill-current" />
                        </div>
                    </div>
                </div>
                ...
                {/* 3. Right (Discord) */}
                <div className="absolute p-3 bg-white rounded-full shadow-lg border border-border/50 flex items-center justify-center ring-8 ring-primary/20 -translate-x-1/2 -translate-y-1/2 left-[90%] top-[50%]">
                    <svg className="w-5 h-5 md:w-6 md:h-6 text-[#5865F2] fill-current" viewBox="0 0 24 24"><path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028c.462-.63.874-1.295 1.226-1.994.021-.041.001-.09-.041-.106a13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 1-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.419-2.157 2.419zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.419-2.157 2.419z"/></svg>
                </div>

                {/* 4. Bottom-Right (TikTok) */}
                <div className="absolute p-3 bg-white rounded-full shadow-lg border border-border/50 flex items-center justify-center ring-8 ring-primary/20 -translate-x-1/2 -translate-y-1/2 left-[78%] top-[78%]">
                ...
                {/* 5. Bottom (LinkedIn) */}
                <div className="absolute p-3 bg-white rounded-full shadow-lg border border-border/50 flex items-center justify-center ring-8 ring-primary/20 -translate-x-1/2 -translate-y-1/2 left-[50%] top-[90%]">
                    <Linkedin className="w-5 h-5 md:w-6 md:h-6 text-[#0077B5]" />
                </div>

                {/* 6. Bottom-Left (Facebook) */}
                <div className="absolute p-3 bg-white rounded-full shadow-lg border border-border/50 flex items-center justify-center ring-8 ring-primary/20 -translate-x-1/2 -translate-y-1/2 left-[22%] top-[78%]">
                    <Facebook className="w-5 h-5 md:w-6 md:h-6 text-[#1877F2]" />
                </div>

                {/* 7. Left (Pinterest) */}
                <div className="absolute p-3 bg-white rounded-full shadow-lg border border-border/50 flex items-center justify-center ring-8 ring-primary/20 -translate-x-1/2 -translate-y-1/2 left-[10%] top-[50%]">
                ...
                <div className="absolute p-3 bg-white rounded-full shadow-lg border border-border/50 flex items-center justify-center ring-8 ring-primary/20 -translate-x-1/2 -translate-y-1/2 left-[22%] top-[22%]">
