        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <ScrollAnimation delay={0} className="relative w-full flex justify-center lg:justify-end">
             <div className="aspect-square w-full max-w-[500px] relative flex items-center justify-center">
                ...
                {/* 1. Top (Reddit) */}
                <div className="absolute p-2.5 bg-white rounded-full shadow-lg border border-border/50 flex items-center justify-center ring-6 ring-primary/20 -translate-x-1/2 -translate-y-1/2 left-[50%] top-[10%]">
                ...
                <div className="absolute p-2.5 bg-white rounded-full shadow-lg border border-border/50 flex items-center justify-center ring-6 ring-primary/20 -translate-x-1/2 -translate-y-1/2 left-[78%] top-[22%]">
                ...
                {/* 3. Right (Discord) */}
                <div className="absolute p-2.5 bg-white rounded-full shadow-lg border border-border/50 flex items-center justify-center ring-6 ring-primary/20 -translate-x-1/2 -translate-y-1/2 left-[90%] top-[50%]">
                ...
                <div className="absolute p-2.5 bg-white rounded-full shadow-lg border border-border/50 flex items-center justify-center ring-6 ring-primary/20 -translate-x-1/2 -translate-y-1/2 left-[78%] top-[78%]">
                ...
                {/* 5. Bottom (LinkedIn) */}
                <div className="absolute p-2.5 bg-white rounded-full shadow-lg border border-border/50 flex items-center justify-center ring-6 ring-primary/20 -translate-x-1/2 -translate-y-1/2 left-[50%] top-[90%]">
                    <Linkedin className="w-4 h-4 md:w-5 md:h-5 text-[#0077B5]" />
                </div>

                {/* 6. Bottom-Left (Facebook) */}
                <div className="absolute p-2.5 bg-white rounded-full shadow-lg border border-border/50 flex items-center justify-center ring-6 ring-primary/20 -translate-x-1/2 -translate-y-1/2 left-[22%] top-[78%]">
                    <Facebook className="w-4 h-4 md:w-5 md:h-5 text-[#1877F2]" />
                </div>

                {/* 7. Left (Pinterest) */}
                <div className="absolute p-2.5 bg-white rounded-full shadow-lg border border-border/50 flex items-center justify-center ring-6 ring-primary/20 -translate-x-1/2 -translate-y-1/2 left-[10%] top-[50%]">
                ...
                <div className="absolute p-2.5 bg-white rounded-full shadow-lg border border-border/50 flex items-center justify-center ring-6 ring-primary/20 -translate-x-1/2 -translate-y-1/2 left-[22%] top-[22%]">
