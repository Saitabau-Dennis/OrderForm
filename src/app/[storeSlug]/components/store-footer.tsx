...
export function StoreFooter({ storeName, socialLinks }: StoreFooterProps) {
  ...
  return (
    <footer id="store-footer" className="bg-background border-t border-[#E8E8E5] mt-16">
                ...
                {links.map((link) => {
                  ...
                  return (
                    <a
                      ...
                      className="flex h-8 w-8 items-center justify-center rounded-none border-2 border-[#1A1A1A] bg-card text-[#1A1A1A] shadow-sm transition-colors hover:bg-[#1A1A1A] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1A1A1A] focus-visible:ring-offset-2"
                    >
