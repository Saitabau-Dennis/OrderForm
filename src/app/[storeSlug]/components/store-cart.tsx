...
import { Minus, Plus, ShoppingBag, X, MessageCircle, ArrowRight, Trash2, ArrowLeft } from "lucide-react";
...
export function StoreCart({ storeName, whatsappNumber }: StoreCartProps) {
  ...
  const handleCheckout = () => {
    ...
    const message = `Hi, I'd like to order from ${storeName}:\n\n${cart.map(item =>
          ...
          <SheetHeader className="px-6 py-5 border-b border-gray-100 flex-shrink-0 bg-white/80 backdrop-blur-md z-10 flex flex-row items-center justify-between space-y-0">
            ...
            <div className="flex items-center gap-3">
              ...
              <button 
                  ...
                  className="h-10 w-10 flex items-center justify-center rounded-full hover:bg-gray-100 -ml-2 transition-colors sm:hidden"
            ...
            {/* Close button is automatically handled by Sheet but we added a custom back for mobile UX */}
