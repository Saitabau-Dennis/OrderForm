    ...
    <section className="py-12 md:py-20 bg-background">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <ScrollAnimation variant="fade-up">
            ...
            <h2 className="text-3xl md:text-5xl font-heading font-medium text-foreground mb-8 leading-tight">
        ...
        <ScrollAnimation variant="fade-up" delay={0.1}>
            <p className="text-xl md:text-2xl text-muted-foreground font-sans font-normal leading-relaxed max-w-3xl mx-auto">
